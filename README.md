...
⚠️ **よくあるエラー**: 「OAuth2 request failed: bad client id」が表示される場合は、`extension/manifest.json`のクライアントIDを確認してください。詳しくは [extension/TROUBLESHOOTING.md](extension/TROUBLESHOOTING.md) をご覧ください。
